<div>
  ...
  <img style="float:left" src="https://img.shields.io/badge/Excel-217346?style=flat-square&amp;logo=microsoftexcel&amp;logoColor=white" width="auto" height="40" />
</div>

# 2024 Cheonan Data Contest Exhibit
- 2024_2st_천안 데이터 공모전_클라우드
- 김민수, 김세현, 이혜준, 이지우

---------------------------------
# Dijkstra Algorithm - 최적경로 탐색
![img](video/최적경로.gif)
